...
declare module Rx ***REMOVED***
	export interface VirtualTimeScheduler<TAbsolute, TRelative> extends Scheduler ***REMOVED***
	...
	***REMOVED***
	...
	export interface HistoricalScheduler extends VirtualTimeScheduler<number, number> ***REMOVED***
	***REMOVED***

	export var HistoricalScheduler: ***REMOVED***
		new (initialClock: number, comparer: (first: number, second: number) => number): HistoricalScheduler;
	***REMOVED***;
***REMOVED***

declare module "rx.virtualtime" ***REMOVED***
	export = Rx;
***REMOVED***
