...
declare module Rx ***REMOVED***
	...
	interface Observable<T> ***REMOVED***
		/**
	...
	***REMOVED***
	...
	interface ObservableStatic ***REMOVED***
		 ...
		 *
		 * @example
		 *  res = Rx.Observable.case(selector, ***REMOVED*** '1': obs1, '2': obs2 ***REMOVED***, obs0);
		 ...
		 */
		case<T>(selector: () => string, sources: ***REMOVED*** [key: string]: Observable<T>; ***REMOVED***, elseSource: Observable<T>): Observable<T>;
		case<T>(selector: () => string, sources: ***REMOVED*** [key: string]: IPromise<T>; ***REMOVED***, elseSource: Observable<T>): Observable<T>;
		case<T>(selector: () => string, sources: ***REMOVED*** [key: string]: Observable<T>; ***REMOVED***, elseSource: IPromise<T>): Observable<T>;
		case<T>(selector: () => string, sources: ***REMOVED*** [key: string]: IPromise<T>; ***REMOVED***, elseSource: IPromise<T>): Observable<T>;
		 ...
		 *
		 * @example
		 *  res = Rx.Observable.case(selector, ***REMOVED*** '1': obs1, '2': obs2 ***REMOVED***);
		 *  res = Rx.Observable.case(selector, ***REMOVED*** '1': obs1, '2': obs2 ***REMOVED***, scheduler);
		 *
		 * @param selector The function which extracts the value for to test in a case statement.
		 * @param sources A object which has keys which correspond to the case statement labels.
		 * @param scheduler Scheduler used to create Rx.Observabe.Empty.
		 ...
		 * @returns An observable sequence which is determined by a case statement.
		 */
		case<T>(selector: () => string, sources: ***REMOVED*** [key: string]: Observable<T>; ***REMOVED***, scheduler?: IScheduler): Observable<T>;
		case<T>(selector: () => string, sources: ***REMOVED*** [key: string]: IPromise<T>; ***REMOVED***, scheduler?: IScheduler): Observable<T>;
		 ...
		 * @returns An observable sequence which is determined by a case statement.
		 */
		case<T>(selector: () => number, sources: ***REMOVED*** [key: number]: Observable<T>; ***REMOVED***, elseSource: Observable<T>): Observable<T>;
		case<T>(selector: () => number, sources: ***REMOVED*** [key: number]: IPromise<T>; ***REMOVED***, elseSource: Observable<T>): Observable<T>;
		case<T>(selector: () => number, sources: ***REMOVED*** [key: number]: Observable<T>; ***REMOVED***, elseSource: IPromise<T>): Observable<T>;
		case<T>(selector: () => number, sources: ***REMOVED*** [key: number]: IPromise<T>; ***REMOVED***, elseSource: IPromise<T>): Observable<T>;
		 ...
		 * @returns An observable sequence which is determined by a case statement.
		 */
		case<T>(selector: () => number, sources: ***REMOVED*** [key: number]: Observable<T>; ***REMOVED***, scheduler?: IScheduler): Observable<T>;
		case<T>(selector: () => number, sources: ***REMOVED*** [key: number]: IPromise<T>; ***REMOVED***, scheduler?: IScheduler): Observable<T>;
		 ...
		 * @returns An observable sequence which is determined by a case statement.
		 */
		switchCase<T>(selector: () => string, sources: ***REMOVED*** [key: string]: Observable<T>; ***REMOVED***, elseSource: Observable<T>): Observable<T>;
		switchCase<T>(selector: () => string, sources: ***REMOVED*** [key: string]: IPromise<T>; ***REMOVED***, elseSource: Observable<T>): Observable<T>;
		switchCase<T>(selector: () => string, sources: ***REMOVED*** [key: string]: Observable<T>; ***REMOVED***, elseSource: IPromise<T>): Observable<T>;
		switchCase<T>(selector: () => string, sources: ***REMOVED*** [key: string]: IPromise<T>; ***REMOVED***, elseSource: IPromise<T>): Observable<T>;
		 ...
		 * @returns An observable sequence which is determined by a case statement.
		 */
		switchCase<T>(selector: () => string, sources: ***REMOVED*** [key: string]: Observable<T>; ***REMOVED***, scheduler?: IScheduler): Observable<T>;
		switchCase<T>(selector: () => string, sources: ***REMOVED*** [key: string]: IPromise<T>; ***REMOVED***, scheduler?: IScheduler): Observable<T>;
		 ...
		 * @returns An observable sequence which is determined by a case statement.
		 */
		switchCase<T>(selector: () => number, sources: ***REMOVED*** [key: number]: Observable<T>; ***REMOVED***, elseSource: Observable<T>): Observable<T>;
		switchCase<T>(selector: () => number, sources: ***REMOVED*** [key: number]: IPromise<T>; ***REMOVED***, elseSource: Observable<T>): Observable<T>;
		switchCase<T>(selector: () => number, sources: ***REMOVED*** [key: number]: Observable<T>; ***REMOVED***, elseSource: IPromise<T>): Observable<T>;
		switchCase<T>(selector: () => number, sources: ***REMOVED*** [key: number]: IPromise<T>; ***REMOVED***, elseSource: IPromise<T>): Observable<T>;
		 ...
		 * @returns An observable sequence which is determined by a case statement.
		 */
		switchCase<T>(selector: () => number, sources: ***REMOVED*** [key: number]: Observable<T>; ***REMOVED***, scheduler?: IScheduler): Observable<T>;
		switchCase<T>(selector: () => number, sources: ***REMOVED*** [key: number]: IPromise<T>; ***REMOVED***, scheduler?: IScheduler): Observable<T>;
...
declare module "rx.experimental" ***REMOVED***
	export = Rx;
***REMOVED***
