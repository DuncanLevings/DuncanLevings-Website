...
module Rx.Tests.Async ***REMOVED***
	...
	***REMOVED***
	...
	function fromCallback() ***REMOVED***
		...
		obsNum = Rx.Observable.fromCallback(func1, ***REMOVED******REMOVED***)("");
		obsNum = Rx.Observable.fromCallback(func1, ***REMOVED******REMOVED***, (results: number[]) => results[0])("");

		// 2 arguments
		var func2: (a: number, b: string, cb: (result: string) => number) => Date;
		obsStr = Rx.Observable.fromCallback(func2)(1, "");
		obsStr = Rx.Observable.fromCallback(func2, ***REMOVED******REMOVED***)(1, "");
		obsStr = Rx.Observable.fromCallback(func2, ***REMOVED******REMOVED***, (results: string[]) => results[0])(1, "");

		// 3 arguments
		var func3: (a: number, b: string, c: boolean, cb: (result: string) => number) => Date;
		obsStr = Rx.Observable.fromCallback(func3)(1, "", true);
		obsStr = Rx.Observable.fromCallback(func3, ***REMOVED******REMOVED***)(1, "", true);
		obsStr = Rx.Observable.fromCallback(func3, ***REMOVED******REMOVED***, (results: string[]) => results[0])(1, "", true);
	...
	***REMOVED***
	...
	function toPromise() ***REMOVED***
		var promiseImpl: ***REMOVED***
