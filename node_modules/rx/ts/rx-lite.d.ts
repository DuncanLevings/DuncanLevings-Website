...
declare module Rx ***REMOVED***
	export module internals ***REMOVED***
		function isEqual(left: any, right: any): boolean;
		function addRef<T>(xs: Observable<T>, r: ***REMOVED*** getDisposable(): IDisposable; ***REMOVED***): Observable<T>;

		// Priority Queue for Scheduling
		export class PriorityQueue<TTime> ***REMOVED***
		...
		***REMOVED***
		...
		export class ScheduledItem<TTime> ***REMOVED***
	...
	***REMOVED***
	...
	export module config ***REMOVED***
		export var Promise: ***REMOVED*** new <T>(resolver: (resolvePromise: (value: T) => void, rejectPromise: (reason: any) => void) => void): IPromise<T>; ***REMOVED***;
	***REMOVED***

	export module helpers ***REMOVED***
		function noop(): void;
	...
	***REMOVED***
	...
	export interface IDisposable ***REMOVED***
		dispose(): void;
	***REMOVED***

	export class CompositeDisposable implements IDisposable ***REMOVED***
	...
	***REMOVED***
	...
	export class Disposable implements IDisposable ***REMOVED***
	...
	***REMOVED***
	...
	// Single assignment
	export class SingleAssignmentDisposable implements IDisposable ***REMOVED***
		constructor();
	...
	***REMOVED***
	...
	export class SerialDisposable extends SingleAssignmentDisposable ***REMOVED***
		constructor();
	***REMOVED***

	export class RefCountDisposable implements IDisposable ***REMOVED***
	...
	***REMOVED***
	...
	export interface Scheduler extends IScheduler ***REMOVED***
	***REMOVED***

	export interface SchedulerStatic ***REMOVED***
		new (
			now: () => number,
	...
	***REMOVED***
	...
	interface ICurrentThreadScheduler extends IScheduler ***REMOVED***
	...
	***REMOVED***
	 ...
	 * Promise A+
	 */
	export interface IPromise<T> ***REMOVED***
	...
	***REMOVED***
	...
	// Observer
	export interface IObserver<T> ***REMOVED***
		onNext(value: T): void;
		onError(exception: any): void;
		onCompleted(): void;
	***REMOVED***

	export interface Observer<T> extends IObserver<T> ***REMOVED***
	...
	***REMOVED***
	...
	export interface IObservable<T> ***REMOVED***
	...
	***REMOVED***
	...
	export interface Observable<T> extends IObservable<T> ***REMOVED***
		...
		*/
		toPromise<TPromise extends IPromise<T>>(promiseCtor: ***REMOVED*** new (resolver: (resolvePromise: (value: T) => void, rejectPromise: (reason: any) => void) => void): TPromise; ***REMOVED***): TPromise;
		/**
		* Converts an existing observable sequence to an ES6 Compatible Promise
		* @example
		* var promise = Rx.Observable.return(42).toPromise(RSVP.Promise);
		...
		* @returns An ES6 compatible promise with the last value from the observable sequence.
		*/
		toPromise(promiseCtor?: ***REMOVED*** new (resolver: (resolvePromise: (value: T) => void, rejectPromise: (reason: any) => void) => void): IPromise<T>; ***REMOVED***): IPromise<T>;
		...
		* @returns ***REMOVED***An exclusive observable with only the results that happen when subscribed.
		*/
	...
	***REMOVED***
	...
	interface ObservableStatic ***REMOVED***
		...
		* @param [scheduler] Optional scheduler to use for scheduling.  If not provided, defaults to Scheduler.currentThread.
		*/
		from<T, TResult>(array: ***REMOVED*** length: number;[index: number]: T; ***REMOVED***, mapFn: (value: T, index: number) => TResult, thisArg?: any, scheduler?: IScheduler): Observable<TResult>;
		/**
		* This method creates a new Observable sequence from an array-like object.
		* @param array An array-like or iterable object to convert to an Observable sequence.
		* @param [mapFn] Map function to call on every element of the array.
		...
		* @param [scheduler] Optional scheduler to use for scheduling.  If not provided, defaults to Scheduler.currentThread.
		*/
		from<T>(array: ***REMOVED*** length: number;[index: number]: T; ***REMOVED***, mapFn?: (value: T, index: number) => T, thisArg?: any, scheduler?: IScheduler): Observable<T>;
		...
		*/
		...
		fromArray<T>(array: ***REMOVED*** length: number;[index: number]: T; ***REMOVED***, scheduler?: IScheduler): Observable<T>;
		...
		*  var res = Rx.Observable.fromIterable(function* () ***REMOVED*** yield 42; ***REMOVED***);
		...
		*/
		fromItreable<T>(generator: () => ***REMOVED*** next(): ***REMOVED*** done: boolean; value?: T; ***REMOVED***; ***REMOVED***, scheduler?: IScheduler): Observable<T>;
		...
		* @returns The observable sequence whose elements are pulled from the given generator sequence.
		*/
		fromItreable<T>(iterable: ***REMOVED******REMOVED***, scheduler?: IScheduler): Observable<T>;	// todo: can't describe ES6 Iterable via TypeScript type system
	...
	***REMOVED***
	...
	interface ISubject<T> extends Observable<T>, Observer<T>, IDisposable ***REMOVED***
		hasObservers(): boolean;
	***REMOVED***

    export interface Subject<T> extends ISubject<T> ***REMOVED***
    ***REMOVED***

    interface SubjectStatic ***REMOVED***
        new <T>(): Subject<T>;
	...
	***REMOVED***
	...
	export interface AsyncSubject<T> extends Subject<T> ***REMOVED***
	***REMOVED***

	interface AsyncSubjectStatic ***REMOVED***
