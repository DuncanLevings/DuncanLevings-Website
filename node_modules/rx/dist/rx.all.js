...
;(function (undefined) ***REMOVED***
  ...
  ***REMOVED***(Scheduler.prototype));
  ...
  (function (schedulerProto) ***REMOVED***
     ...
     * @param ***REMOVED***Function***REMOVED*** handler Handler that's run if an exception is caught. The exception will be rethrown if the handler returns false.
     * @returns ***REMOVED***Scheduler***REMOVED*** Wrapper around the original scheduler, enforcing exception handling.
     */
    schedulerProto.catchError = schedulerProto['catch'] = function (handler) ***REMOVED***
  ...
  ***REMOVED***;
   ...
   */
  observableProto.concatMapObserver = observableProto.selectConcatObserver = function(onNext, onError, onCompleted, thisArg) ***REMOVED***
    var source = this,
  ...
  ***REMOVED***;
   ...
   * @param ***REMOVED***Number***REMOVED*** timeSpan Length of each window (specified as an integer denoting milliseconds).
   * @param ***REMOVED***Mixed***REMOVED*** [timeShiftOrScheduler]  Interval between creation of consecutive windows (specified as an integer denoting milliseconds), or an optional scheduler parameter. If not specified, the time shift corresponds to the timeSpan parameter, resulting in non-overlapping adjacent windows.
   ...
   * @returns ***REMOVED***Observable***REMOVED*** An observable sequence of windows.
   */
  observableProto.windowWithTime = function (timeSpan, timeShiftOrScheduler, scheduler) ***REMOVED***
    var source = this, timeShift;
    timeShiftOrScheduler == null && (timeShift = timeSpan);
    isScheduler(scheduler) || (scheduler = timeoutScheduler);
    if (typeof timeShiftOrScheduler === 'number') ***REMOVED***
      timeShift = timeShiftOrScheduler;
    ***REMOVED*** else if (isScheduler(timeShiftOrScheduler)) ***REMOVED***
      timeShift = timeSpan;
    ...
    return new AnonymousObservable(function (observer) ***REMOVED***
      var groupDisposable,
       ...
       function createTimer () ***REMOVED***
        ...
        if (nextSpan === nextShift) ***REMOVED***
          isSpan = true;
          isShift = true;
        ***REMOVED*** else if (nextSpan < nextShift) ***REMOVED***
            isSpan = true;
        ***REMOVED*** else ***REMOVED***
          isShift = true;
        ***REMOVED***
        ...
        ***REMOVED***
        if (isShift) ***REMOVED***
          nextShift += timeShift;
        ***REMOVED***
        m.setDisposable(scheduler.scheduleWithRelative(ts, function () ***REMOVED***
          if (isShift) ***REMOVED***
            var s = new Subject();
            q.push(s);
            observer.onNext(addRef(s, refCountDisposable));
      ...
      ***REMOVED***;
      ...
      groupDisposable.add(source.subscribe(
        ...
        ***REMOVED***,
        function (e) ***REMOVED***
          for (var i = 0, len = q.length; i < len; i++) ***REMOVED*** q[i].onError(e); ***REMOVED***
          observer.onError(e);
        ***REMOVED***,
        function () ***REMOVED***
          for (var i = 0, len = q.length; i < len; i++) ***REMOVED*** q[i].onCompleted(); ***REMOVED***
          observer.onCompleted();
        ***REMOVED***
      ));
      return refCountDisposable;
  ...
  ***REMOVED***;
     ...
     *
     * @param ***REMOVED***Number***REMOVED*** timeSpan Length of each buffer (specified as an integer denoting milliseconds).
     * @param ***REMOVED***Mixed***REMOVED*** [timeShiftOrScheduler]  Interval between creation of consecutive buffers (specified as an integer denoting milliseconds), or an optional scheduler parameter. If not specified, the time shift corresponds to the timeSpan parameter, resulting in non-overlapping adjacent buffers.
     * @param ***REMOVED***Scheduler***REMOVED*** [scheduler]  Scheduler to run buffer timers on. If not specified, the timeout scheduler is used.
     * @returns ***REMOVED***Observable***REMOVED*** An observable sequence of buffers.
     */
    observableProto.bufferWithTime = function (timeSpan, timeShiftOrScheduler, scheduler) ***REMOVED***
        return this.windowWithTime.apply(this, arguments).selectMany(function (x) ***REMOVED*** return x.toArray(); ***REMOVED***);
    ***REMOVED***;
  ...
  ***REMOVED***;
   ...
   * @param ***REMOVED***Number***REMOVED*** duration Duration for taking elements from the end of the sequence.
   * @param ***REMOVED***Scheduler***REMOVED*** scheduler Scheduler to run the timer on. If not specified, defaults to Rx.Scheduler.timeout.
   * @returns ***REMOVED***Observable***REMOVED*** An observable sequence containing a single array with the elements taken during the specified duration from the end of the source sequence.
   */
  observableProto.takeLastBufferWithTime = function (duration, scheduler) ***REMOVED***
    var source = this;
    isScheduler(scheduler) || (scheduler = timeoutScheduler);
    return new AnonymousObservable(function (o) ***REMOVED***
      var q = [];
  ...
  ***REMOVED***;
   ...
   *  As more elements are received, elements older than the specified duration are taken from the queue and produced on the
   *  result sequence. This causes elements to be delayed with duration.
   * @param ***REMOVED***Number***REMOVED*** duration Duration for taking elements from the start of the sequence.
   * @param ***REMOVED***Scheduler***REMOVED*** scheduler Scheduler to run the timer on. If not specified, defaults to Rx.Scheduler.timeout.
   * @returns ***REMOVED***Observable***REMOVED*** An observable sequence with the elements taken during the specified duration from the start of the source sequence.
   */
  observableProto.takeWithTime = function (duration, scheduler) ***REMOVED***
    var source = this;
    isScheduler(scheduler) || (scheduler = timeoutScheduler);
    return new AnonymousObservable(function (o) ***REMOVED***
      return new CompositeDisposable(scheduler.scheduleWithRelative(duration, function () ***REMOVED*** o.onCompleted(); ***REMOVED***), source.subscribe(o));
    ***REMOVED***, source);
  ***REMOVED***;
   ...
   * @param ***REMOVED***Number***REMOVED*** duration Duration for skipping elements from the start of the sequence.
   * @param ***REMOVED***Scheduler***REMOVED*** scheduler Scheduler to run the timer on. If not specified, defaults to Rx.Scheduler.timeout.
   * @returns ***REMOVED***Observable***REMOVED*** An observable sequence with the elements skipped during the specified duration from the start of the source sequence.
   */
  observableProto.skipWithTime = function (duration, scheduler) ***REMOVED***
    var source = this;
    isScheduler(scheduler) || (scheduler = timeoutScheduler);
    return new AnonymousObservable(function (observer) ***REMOVED***
      var open = false;
      return new CompositeDisposable(
        scheduler.scheduleWithRelative(duration, function () ***REMOVED*** open = true; ***REMOVED***),
        source.subscribe(function (x) ***REMOVED*** open && observer.onNext(x); ***REMOVED***, observer.onError.bind(observer), observer.onCompleted.bind(observer)));
    ***REMOVED***, source);
  ***REMOVED***;
   ...
   * @param ***REMOVED***Date|Number***REMOVED*** startTime Time to start taking elements from the source sequence. If this value is less than or equal to Date(), no elements will be skipped.
   * @param ***REMOVED***Scheduler***REMOVED*** [scheduler] Scheduler to run the timer on. If not specified, defaults to Rx.Scheduler.timeout.
   * @returns ***REMOVED***Observable***REMOVED*** An observable sequence with the elements skipped until the specified start time.
   */
  observableProto.skipUntilWithTime = function (startTime, scheduler) ***REMOVED***
    isScheduler(scheduler) || (scheduler = timeoutScheduler);
    ...
    return new AnonymousObservable(function (o) ***REMOVED***
      ...
      return new CompositeDisposable(
        scheduler[schedulerMethod](startTime, function () ***REMOVED*** open = true; ***REMOVED***),
        source.subscribe(
          function (x) ***REMOVED*** open && o.onNext(x); ***REMOVED***,
          function (e) ***REMOVED*** o.onError(e); ***REMOVED***, function () ***REMOVED*** o.onCompleted(); ***REMOVED***));
    ***REMOVED***, source);
  ***REMOVED***;
