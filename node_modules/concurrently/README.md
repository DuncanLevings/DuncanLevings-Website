...
Options:
  ...
  Possible values: index, pid, time, command, name, none, or a template. Default: index or name (when --names is set). Example template: "***REMOVED***time***REMOVED***-***REMOVED***pid***REMOVED***"
