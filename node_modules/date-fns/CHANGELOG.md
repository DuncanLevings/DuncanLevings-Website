...
- In `parse`, added ability to specify the number of additional digits
  ...
  ```javascript
  parse('+002016-11-01')
  parse('+02016-11-01', ***REMOVED***additionalDigits: 1***REMOVED***)
  parse('+2016-11-01', ***REMOVED***additionalDigits: 0***REMOVED***)
  ```
...
- **BREAKING**: functions that had the last optional argument `weekStartsAt`
  ...
  // v1.0.0 onward
  var result = endOfWeek(new Date(2014, 8, 2), ***REMOVED***weekStartsOn: 1***REMOVED***)
  ```
