...
- `***REMOVED***packageName***REMOVED***` - Package name.
- `***REMOVED***currentVersion***REMOVED***` - Current version.
- `***REMOVED***latestVersion***REMOVED***` - Latest version.
- `***REMOVED***updateCommand***REMOVED***` - Update command.

```js
notifier.notify(***REMOVED***message: 'Run `***REMOVED***updateCommand***REMOVED***` to update.'***REMOVED***);
