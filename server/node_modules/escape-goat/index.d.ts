...
@example
```
import ***REMOVED***htmlEscape***REMOVED*** from 'escape-goat';
...
@example
```
import ***REMOVED***htmlUnescape***REMOVED*** from 'escape-goat';
...
@example
```
import ***REMOVED***htmlEscapeTag***REMOVED*** from 'escape-goat';

const url = 'https://sindresorhus.com?x="🦄"';

htmlEscapeTag`<a href="$***REMOVED***url***REMOVED***">Unicorn</a>`;
...
@example
```
import ***REMOVED***htmlUnescapeTag***REMOVED*** from 'escape-goat';

const escapedUrl = 'https://sindresorhus.com?x=&quot;🦄&quot;';

htmlUnescapeTag`URL from HTML: $***REMOVED***url***REMOVED***`;
