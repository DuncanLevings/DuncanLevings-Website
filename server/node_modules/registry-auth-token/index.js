...
function getLegacyAuthInfo (npmrc) ***REMOVED***
  ...
  ***REMOVED***
  ...
  return ***REMOVED*** token: token, type: 'Basic' ***REMOVED***
***REMOVED***
...
function replaceEnvironmentVariable (token) ***REMOVED***
  return token.replace(/^\$\***REMOVED***?([^***REMOVED***]*)\***REMOVED***?$/, function (fullMatch, envVar) ***REMOVED***
...
function getLegacyAuthToken (tok) ***REMOVED***
  if (!tok) ***REMOVED***
    return undefined
  ***REMOVED***
