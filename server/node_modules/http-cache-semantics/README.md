...
letsPretendThisIsSomeCache.set(
    request.url,
    ***REMOVED*** policy, response ***REMOVED***,
    policy.timeToLive()
);
```
...
const ***REMOVED*** policy, response ***REMOVED*** = letsPretendThisIsSomeCache.get(newRequest.url);

// It's not enough that it exists in the cache, it has to match the new request, too:
if (policy && policy.satisfiesWithoutRevalidation(newRequest)) ***REMOVED***
...
const ***REMOVED*** oldPolicy, oldResponse ***REMOVED*** = letsPretendThisIsSomeCache.get(
    newRequest.url
);

if (!oldPolicy.satisfiesWithoutRevalidation(newRequest)) ***REMOVED***
    ...
    const ***REMOVED*** policy, modified ***REMOVED*** = oldPolicy.revalidatedPolicy(
        newRequest,
        newResponse
    );
