 ...
 */
export interface OnCancelFunction ***REMOVED***
	(cancelHandler: () => void): void;
	shouldReject: boolean;
***REMOVED***

declare class PCancelable<ValueType> extends Promise<ValueType> ***REMOVED***
	/**
	 ...
	 *
	 * const fn = PCancelable.fn((input, onCancel) => ***REMOVED***
	 * 	const job = new Job();
	 *
	 * 	onCancel(() => ***REMOVED***
	 * 		job.cleanup();
	 ...
	 * import PCancelable from 'p-cancelable';
	 *
	 * const cancelablePromise = new PCancelable((resolve, reject, onCancel) => ***REMOVED***
	 * 	const job = new Job();
	 *
 ...
 */
export class CancelError extends Error ***REMOVED***
