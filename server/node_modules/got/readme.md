...
```js
await got('hello', ***REMOVED***baseUrl: 'https://example.com/v1'***REMOVED***);
...
got('https://example.com', ***REMOVED***query***REMOVED***);
...
const query = queryString.stringify(***REMOVED***key: ['a', 'b']***REMOVED***, ***REMOVED***arrayFormat: 'bracket'***REMOVED***);
...
const ***REMOVED***HttpsAgent***REMOVED*** = HttpAgent;

got('sindresorhus.com', ***REMOVED***
	agent: ***REMOVED***
		http: new HttpAgent(),
...
got('example.com', ***REMOVED***
	hooks: ***REMOVED***
		beforeRedirect: [
			options => ***REMOVED***
				if (options.hostname === 'deadSite') ***REMOVED***
...
got('example.com', ***REMOVED***
	hooks: ***REMOVED***
		beforeRetry: [
			(options, error, retryCount) => ***REMOVED***
				if (error.statusCode === 413) ***REMOVED*** // Payload too large
...
const instance = got.extend(***REMOVED***
	hooks: ***REMOVED***
		afterResponse: [
			(response, retryWithMergedOptions) => ***REMOVED***
				if (response.statusCode === 401) ***REMOVED*** // Unauthorized
					const updatedOptions = ***REMOVED***
						headers: ***REMOVED***
...
got('api.github.com/some-endpoint', ***REMOVED***	
	hooks: ***REMOVED***	
		onError: [	
			error => ***REMOVED***	
				const ***REMOVED***response***REMOVED*** = error;	
 				if (response && response.body) ***REMOVED***	
					error.name = 'GitHubError';	
					error.message = `$***REMOVED***response.body.message***REMOVED*** ($***REMOVED***error.statusCode***REMOVED***)`;	
				***REMOVED***
...
(async () => ***REMOVED***
	const response = await got('sindresorhus.com')
		.on('downloadProgress', progress => ***REMOVED***
			// Report download progress
		***REMOVED***)
		.on('uploadProgress', progress => ***REMOVED***
...
```js
const client = got.extend(***REMOVED***
...
(async () => ***REMOVED***
	const client = got.extend(***REMOVED***
		...
		***REMOVED***
	***REMOVED***);
	const ***REMOVED***headers***REMOVED*** = (await client.get('/headers', ***REMOVED***json: true***REMOVED***)).body;
	//=> headers['x-foo'] === 'bar'

	const jsonClient = client.extend(***REMOVED***
		json: true,
		headers: ***REMOVED***
			'x-baz': 'qux'
		***REMOVED***
	***REMOVED***);
	const ***REMOVED***headers: headers2***REMOVED*** = (await jsonClient.get('/headers')).body;
	//=> headers2['x-foo'] === 'bar'
	//=> headers2['x-baz'] === 'qux'
***REMOVED***)();
```
...
```js
const a = ***REMOVED***headers: ***REMOVED***cat: 'meow', wolf: ['bark', 'wrrr']***REMOVED******REMOVED***;
const b = ***REMOVED***headers: ***REMOVED***cow: 'moo', wolf: ['auuu']***REMOVED******REMOVED***;

***REMOVED***...a, ...b***REMOVED***            // => ***REMOVED***headers: ***REMOVED***cow: 'moo', wolf: ['auuu']***REMOVED******REMOVED***
got.mergeOptions(a, b)  // => ***REMOVED***headers: ***REMOVED***cat: 'meow', cow: 'moo', wolf: ['auuu']***REMOVED******REMOVED***
```
...
(async () => ***REMOVED***
	...
	***REMOVED***
	...
	try ***REMOVED***
		await request;
	***REMOVED*** catch (error) ***REMOVED***
		if (request.isCanceled) ***REMOVED*** // Or `error instanceof got.CancelError`
			// Handle cancelation
		***REMOVED***
...
(async () => ***REMOVED***
		let response = await got('sindresorhus.com', ***REMOVED***cache: map***REMOVED***);
		console.log(response.fromCache);
		//=> false

		response = await got('sindresorhus.com', ***REMOVED***cache: map***REMOVED***);
		console.log(response.fromCache);
		//=> true
***REMOVED***)();
```
...
got('sindresorhus.com', ***REMOVED***cache: redis***REMOVED***);
```
...
const storageAdapter = new QuickLRU(***REMOVED***maxSize: 1000***REMOVED***);

got('sindresorhus.com', ***REMOVED***cache: storageAdapter***REMOVED***);
```
...
```js
const got = require('got');
const ***REMOVED***CookieJar***REMOVED*** = require('tough-cookie');

const cookieJar = new CookieJar();
cookieJar.setCookie('foo=bar', 'https://www.google.com');

got('google.com', ***REMOVED***cookieJar***REMOVED***);
```
...
const response = await awsClient('endpoint/path', ***REMOVED***
...
got('sindresorhus.com', ***REMOVED***
	headers: ***REMOVED***
		'user-agent': `my-package/$***REMOVED***pkg.version***REMOVED*** (https://github.com/username/my-package)`
	***REMOVED***
***REMOVED***);
...
const custom = got.extend(***REMOVED***
	baseUrl: 'example.com',
	json: true,
	headers: ***REMOVED***
		'user-agent': `my-package/$***REMOVED***pkg.version***REMOVED*** (https://github.com/username/my-package)`
...
```js
const got = require('got');
const ***REMOVED***request***REMOVED*** = require('http2-wrapper');

const h2got = got.extend(***REMOVED***request***REMOVED***);

(async () => ***REMOVED***
	const ***REMOVED***body***REMOVED*** = await h2got('https://nghttp2.org/httpbin/headers');
	console.log(body);
***REMOVED***)();
```
