  ...
  config.load(settings, function (config) ***REMOVED***
    ...
    ***REMOVED***);
    ...
    if (config.options.stdin && config.options.restartable) ***REMOVED***
      ...
      process.stdin.on('data', data => ***REMOVED***
        const str = data.toString().trim().toLowerCase();

        // if the keys entered match the restartable value, then restart!
        if (str === config.options.restartable) ***REMOVED***
          bus.emit('restart');
        ***REMOVED*** else if (data.charCodeAt(0) === 12) ***REMOVED*** // ctrl+l
          console.clear();
        ***REMOVED***
      ***REMOVED***);
      ...
      process.stdin.on('data', function (data) ***REMOVED***
        ...
        if (chr === 3) ***REMOVED***
          ...
          ***REMOVED***
          ...
          ctrlC = true;
          return;
        ***REMOVED*** else if (buffer === '.exit' || chr === 4) ***REMOVED*** // ctrl+d
          process.exit();
        ***REMOVED*** else if (chr === 13 || chr === 10) ***REMOVED*** // enter / carriage return
          buffer = '';
        ***REMOVED*** else if (chr === 12) ***REMOVED*** // ctrl+l
          console.clear();
          buffer = '';
        ***REMOVED***
        ctrlC = false;
    ...
    ***REMOVED***).filter(Boolean).join(' ');
    ...
    utils.log.info('watching path(s): ' + config.options.monitor.map(function (rule) ***REMOVED***
      if (rule.slice(0, 1) !== '!') ***REMOVED***
        try ***REMOVED***
