...
```js
process.once("SIGHUP", function () ***REMOVED***
...
if (cluster.isMaster) ***REMOVED***
  process.on("SIGHUP", function () ***REMOVED***
    for (const worker of Object.values(cluster.workers)) ***REMOVED***
      worker.process.kill("SIGTERM");
    ***REMOVED***
  ***REMOVED***);
***REMOVED*** else ***REMOVED***
  process.on("SIGHUP", function() ***REMOVED******REMOVED***)
***REMOVED***
```
