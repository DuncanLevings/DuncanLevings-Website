...
picomatch.compileRe = (parsed, options, returnOutput = false, returnState = false) => ***REMOVED***
  ...
  ***REMOVED***
  ...
  let source = `$***REMOVED***prepend***REMOVED***(?:$***REMOVED***parsed.output***REMOVED***)$***REMOVED***append***REMOVED***`;
  if (parsed && parsed.negated === true) ***REMOVED***
...
picomatch.makeRe = (input, options, returnOutput = false, returnState = false) => ***REMOVED***
  ...
  ***REMOVED***
  ...
  if (opts.fastpaths !== false && (input[0] === '.' || input[0] === '*')) ***REMOVED***
    output = parse.fastpaths(input, options);
  ***REMOVED***

  if (output === undefined) ***REMOVED***
