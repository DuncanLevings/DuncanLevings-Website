...
export interface ArrayLike ***REMOVED***
    length: number;
***REMOVED***
export interface Class<T = unknown> ***REMOVED***
    new (...args: any[]): T;
***REMOVED***
declare type DomElement = object & ***REMOVED***
    nodeType: 1;
    nodeName: string;
***REMOVED***;
declare type NodeStream = object & ***REMOVED***
    pipe: Function;
***REMOVED***;
export declare const enum TypeName ***REMOVED***
    null = "null",
    boolean = "boolean",
    undefined = "undefined",
    string = "string",
