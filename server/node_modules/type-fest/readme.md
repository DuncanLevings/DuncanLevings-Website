...
```ts
import ***REMOVED***Except***REMOVED*** from 'type-fest';
...
- [`Partial<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1401-L1406) - Make all properties in `T` optional.
	...
	```ts
	interface NodeConfig ***REMOVED***
			appName: string;
			port: number;
	***REMOVED***

	class NodeAppBuilder ***REMOVED***
			private configuration: NodeConfig = ***REMOVED***
					appName: 'NodeApp',
					port: 3000
			***REMOVED***;

			config(config: Partial<NodeConfig>) ***REMOVED***
					type NodeConfigKey = keyof NodeConfig;

					for (const key of Object.keys(config) as NodeConfigKey[]) ***REMOVED***
							const updateValue = config[key];

							if (updateValue === undefined) ***REMOVED***
									continue;
							***REMOVED***
	...
	***REMOVED***
	...
	new NodeAppBuilder().config(***REMOVED***appName: 'ToDoApp'***REMOVED***);
	```
	</details>
...
- [`Required<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1408-L1413) - Make all properties in `T` required.
	...
	```ts
	interface ContactForm ***REMOVED***
			email?: string;
			message?: string;
	***REMOVED***

	function submitContactForm(formData: Required<ContactForm>) ***REMOVED***
			// Send the form data to the server.
	***REMOVED***

	submitContactForm(***REMOVED***
			email: 'ex@mple.com',
...
- [`Readonly<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1415-L1420) - Make all properties in `T` readonly.
	...
	***REMOVED***;
	...
	interface LoggerConfig ***REMOVED***
			name: string;
			level: LogLevel;
	***REMOVED***
	...
	class Logger ***REMOVED***
			...
			constructor(***REMOVED***name, level***REMOVED***: LoggerConfig) ***REMOVED***
					this.config = ***REMOVED***name, level***REMOVED***;
					Object.freeze(this.config);
			***REMOVED***
	***REMOVED***

	const config: LoggerConfig = ***REMOVED***
		name: 'MyApp',
...
- [`Pick<T, K>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1422-L1427) - From `T`, pick a set of properties whose keys are in the union `K`.
	...
	***REMOVED***
	...
	// `ArticlePreview = ***REMOVED***title: string; thumbnail: string***REMOVED***`
	type ArticlePreview = Pick<Article, 'title' | 'thumbnail'>;

	// Render a list of articles using only title and description.
	function renderArticlePreviews(previews: ArticlePreview[]): HTMLElement ***REMOVED***
			const articles = document.createElement('div');

			for (const preview of previews) ***REMOVED***
...
- [`Record<K, T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1429-L1434) - Construct a type with a set of properties `K` of type `T`.
	...
	***REMOVED***
	...
	const team: Record<MemberPosition, Employee[]> = ***REMOVED***
			intern: [],
			developer: [],
			'tech-lead': [],
	***REMOVED***;
	...
	***REMOVED***);
	...
	const teamEmpty: Record<MemberPosition, null> = ***REMOVED***
			intern: null,
			developer: null,
	***REMOVED***;
	```
...
- [`Exclude<T, U>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1436-L1439) - Exclude from `T` those types that are assignable to `U`.
	...
	```ts
	interface ServerConfig ***REMOVED***
	...
	***REMOVED***
	...
	function getPortValue(port: Exclude<ServerConfig['port'], null>): number ***REMOVED***
	...
	***REMOVED***
	...
	function startServer(handler: RequestHandler, config: ServerConfig): void ***REMOVED***
...
- [`Extract<T, U>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1441-L1444) - Extract from `T` those types that are assignable to `U`.
	...
	***REMOVED***
	...
	> (obj: Obj, key: Key, value: Value): void ***REMOVED***
		obj[key] = value;
	***REMOVED***

	// Tiny Andrew was born.
	const andrew = ***REMOVED***
		[ID]: uniqueId(),
		name: 'Andrew',
		age: 0,
	***REMOVED***;
...
- [`NonNullable<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1446-L1449) - Exclude `null` and `undefined` from `T`.
	...
	class ServerBuilder ***REMOVED***
			portNumber!: NonNullable<PortNumber>;

			port(this: ServerBuilder, port: PortNumber): ServerBuilder ***REMOVED***
...
- [`Parameters<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1451-L1454) - Obtain the parameters of a function type in a tuple.
	...
	```ts
	function shuffle(input: any[]): void ***REMOVED***
		// Mutate array randomly changing its' elements indexes.
	***REMOVED***

	function callNTimes<Fn extends (...args: any[]) => any> (func: Fn, callCount: number) ***REMOVED***
		// Type that represents the type of the received function parameters.
		type FunctionParameters = Parameters<Fn>;

		return function (...args: FunctionParameters) ***REMOVED***
			for (let i = 0; i < callCount; i++) ***REMOVED***
				func(...args);
			***REMOVED***
		***REMOVED***
	***REMOVED***
...
- [`ConstructorParameters<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1456-L1459) - Obtain the parameters of a constructor function type in a tuple.
	...
	```ts
	class ArticleModel ***REMOVED***
		title: string;
		content?: string;

		constructor(title: string) ***REMOVED***
			this.title = title;
		***REMOVED***
	***REMOVED***

	class InstanceCache<T extends (new (...args: any[]) => any)> ***REMOVED***
		private ClassConstructor: T;
		private cache: Map<string, InstanceType<T>> = new Map();

		constructor (ctr: T) ***REMOVED***
			this.ClassConstructor = ctr;
		***REMOVED***

		getInstance (...args: ConstructorParameters<T>): InstanceType<T> ***REMOVED***
			const hash = this.calculateArgumentsHash(...args);

			const existingInstance = this.cache.get(hash);
			if (existingInstance !== undefined) ***REMOVED***
		...
		***REMOVED***
		...
		private calculateArgumentsHash(...args: any[]): string ***REMOVED***
			// Calculate hash.
			return 'hash';
		***REMOVED***
	***REMOVED***
...
- [`ReturnType<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1461-L1464) – Obtain the return type of a function type.
	...
	>(iter: Iterable<Elem>, callback: Func): Ret[] ***REMOVED***
			const mapped: Ret[] = [];

			for (const elem of iter) ***REMOVED***
	...
	***REMOVED***
	...
	mapIter(mapObject, ([key, value]: [number, string]) => ***REMOVED***
...
- [`InstanceType<T>`](https://github.com/Microsoft/TypeScript/blob/2961bc3fc0ea1117d4e53bc8e97fa76119bc33e3/src/lib/es5.d.ts#L1466-L1469) – Obtain the instance type of a constructor function type.
	...
	```ts
	class IdleService ***REMOVED***
			doNothing (): void ***REMOVED******REMOVED***
	***REMOVED***
	...
	class News ***REMOVED***
			...
			constructor(title: string, content: string) ***REMOVED***
					this.title = title;
	...
	***REMOVED***
	...
	>(constructor: Constr, ...args: Args): InstanceType<Constr> ***REMOVED***
			...
			console.log(`Created $***REMOVED***count + 1***REMOVED*** instances of $***REMOVED***Constr.name***REMOVED*** class`);
...
- [`Omit<T, K>`](https://github.com/microsoft/TypeScript/blob/71af02f7459dc812e85ac31365bfe23daf14b4e4/src/lib/es5.d.ts#L1446) – Constructs a type by picking all properties from T and then removing K.
	...
	***REMOVED***
	...
	function renderAnimalHoverInfo (animals: AnimalShortInfo[]): HTMLElement ***REMOVED***
