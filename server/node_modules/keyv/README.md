...
```js
const users = new Keyv('redis://user:pass@localhost:6379', ***REMOVED*** namespace: 'users' ***REMOVED***);
const cache = new Keyv('redis://user:pass@localhost:6379', ***REMOVED*** namespace: 'cache' ***REMOVED***);
...
```js
const keyv = new Keyv(***REMOVED*** serialize: JSON.stringify, deserialize: JSON.parse ***REMOVED***);
```
...
const keyv = new Keyv(***REMOVED*** store: myAdapter ***REMOVED***);
```

Any store that follows the [`Map`](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Map) api will work.

```js
new Keyv(***REMOVED*** store: new Map() ***REMOVED***);
```
...
const keyv = new Keyv(***REMOVED*** store: lru ***REMOVED***);
```
...
const awesomeModule = new AwesomeModule(***REMOVED*** cache: 'redis://localhost' ***REMOVED***);

// Some third-party module that implements the Map API
const awesomeModule = new AwesomeModule(***REMOVED*** cache: some3rdPartyStore ***REMOVED***);
```
